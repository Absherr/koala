...
public class Rejestracja extends javax.swing.JFrame {
    ...
    final static String mIp = "localhost";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if(!lvKlient.createUser(jTextField1.getText(), jTextField2.getText())) 
            {
                    JOptionPane.showMessageDialog(null, "Nieudana rejestracja, nazwa użytkownika jest już zajeta");
            }else
            {
                this.dispose();
                new Logowanie().setVisible(true);
