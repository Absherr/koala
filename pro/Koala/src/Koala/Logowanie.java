...
public class Logowanie extends javax.swing.JFrame {
    ...
    public String logi; //trzyma login
    public String pass; // trzyma hasło
    ...
    private void initComponents() {
        ...
        logText.setText("admin");
        logText.setToolTipText("Podaj login");

        passText.setText("root");
        passText.setToolTipText("Podaj hasło");

        jLabel1.setText("Hasło:");
        jLabel1.setToolTipText("Podaj hasło");

        jLabel2.setText("Login:");
        jLabel2.setToolTipText("Podaj login");
    ...
    private void logButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logButtonActionPerformed
        try {
            logi = this.logText.getText();
            if ("".equals(logi)) {
                throw new Exception("Brak loginu");//pusty login
            }
            pass = this.passText.getText();
            if ("".equals(pass)) {
                throw new Exception("Brak hasła");//puste haslo
            }
            Client program = new Client("localhost",63400);
            program.loginToServer(logi, pass, null); //logowanie
            this.setVisible(false);
            MainFrame okienko = new MainFrame(program, logi, pass); //nowe okno
